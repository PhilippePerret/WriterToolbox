...
class AnalyseBuild
  ...
  def extract_form
    ...
    (
      ...
      form.field_select('Type d’extraction', 'type', nil, {values: AnalyseBuild::Thing::DATA_THINGS}) +
  ...
  def menus_from_time_to_time
    'de' +
    '0:00:00'.in_input_text(class: 'medium', name: 'thing[from_time]', id: 'thing_from_time')+
    'à' +
    'FIN'.in_input_text(class: 'medium', name: 'thing[to_time]', id: 'thing_to_time')
  end
