...
La toute première chose à faire est de s'inscrire au programme \unan{} sur le site de \boa{}. Si vous êtes déjà inscrit\fem{e}, vous pouvez passer cette partie pour \hyperlink{premiers-pas-apres-inscription}{poursuivre cette présentation des premiers pas}.

Deux procédures d'inscription au programme sont possibles suivant que~{}:

\begin{itemize}
\item vous êtes déjà inscrit\fem{e} sur le site ou même abonn\fem{e}~{}: suivez la \hyperlink{procedure-inscription-rapide}{procédure d'inscription rapide au programme}~{};
...
Pour ce faire, rejoignez voter bureau —~{}simplement en cliquant sur ``1 an 1 script'' dans votre marge gauche si vous êtes encore connecté\fem{e} ou en suivant la \hyperlink{rejoindre-bureau-travail}{procédure de connexion à son bureau} si ça n'est plus le cas. Ensuite~{}:
