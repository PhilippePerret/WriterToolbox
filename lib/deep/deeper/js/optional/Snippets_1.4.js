...
window.Snippet.prototype = {
  ...
  replace_and_wait:function(){
    // Si une fonction doit être exécutée, on l'exécute
    this.exec_function_if_needed();
  ...
  // Si la propriété `func` est définie dans les données,
  // c'est une fonction qu'il faut exécuter.
  exec_function_if_needed:function(){
...
Object.defineProperties(Snippet.prototype,{
  ...
  // La function à jouer if any
  func:{get:function(){return this.data.func}},
