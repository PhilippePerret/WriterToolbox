...
class CRON2
  ...
  def autorisations
    Autorisations.check_autorisations
  end
  ...
  class Autorisations
    ...
    class << self
      ...
      def check_autorisations
        ...
        autorisations.each do |uid, uautos|
          ...
          good_autos.each do |dauto|
            if temps_debut.nil? || (dauto[:start_time] && dauto[:start_time] < temp_debut)
      ...
      def fin_echeance_abonnement huser
        ...
        l'abonnement n'est que de #{site.tarif_humain}).</p>
      ...
      def check_if_alerte_requise huser
        ...
        30_semaines_avant   = NOW - 30.weeks
        moins_de_jours =
          case true
          ...
          when temps_debut < 30_semaines_avant && temps_fin < dans_trois_semaines
        ...
        ré-abonner pour #{site.tarif_humain}.</p>
      ...
      def autorisations
        @autorisations ||= begin
          h = Hash.new
          table_autorisations.select.each do |row|
